...
var make_lustre_client_component = ({ init: init4, update: update3, view: view3, on_attribute_change }, name) => {
  if (!is_browser())
    return new Error(new NotABrowser());
  if (!name.includes("-"))
...
function popover_header() {
  return class$("font-medium leading-none");
}
function popover_description() {
  return class$("text-sm text-muted-foreground");
}
...
function button2(children2, attrs, classes, variant) {
  return button(
    prepend(
      class$(
        doTwMerge(
            ...
            prepend(
              (() => {
                if (variant instanceof Default) {
                  ...
                  return "hover:bg-accent hover:text-accent-foreground border border-transparent";
                }
              })(),
              classes
            )
...
var getMainContainer = () => {
  const mainContainer = document.getElementsByTagName("route-dashboard")[0].shadowRoot.getElementById("main");
...
function users_round(attributes) {
  return svg(
    prepend(
      attribute("stroke-linejoin", "round"),
      prepend(
    ...
    toList([
      path(toList([attribute("d", "M18 21a8 8 0 0 0-16 0")])),
      circle(
        toList([
          attribute("r", "5"),
          attribute("cy", "8"),
      ...
      path(
        toList([attribute("d", "M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3")])
      )
    ])
  );
}
function panel_left(attributes) {
  return svg(
    prepend(
      attribute("stroke-linejoin", "round"),
      prepend(
    ...
    toList([
      ...
      path(toList([attribute("d", "M9 3v18")]))
    ])
  );
}
  ...
  if (msg instanceof RequestToggleSidebar) {
    ...
    let columns = (() => {
      let _pipe = divideFloat(
        x - (divideFloat(x, 148) * 2 - 1) * 12,
        148
      ) * 2;
      return round2(_pipe);
    })();
    let main_container_width = getMainContainer().width - 24;
    let max_columns = (() => {
      let _pipe = floor2(
        divideFloat(main_container_width + 12, 148 + 12)
      );
      return round2(_pipe);
    })();
    return [
    ...
    if (!grab) {
      return [
        model.withFields({
          grabbing: grab,
          columns_grab_x: (() => {
            let $ = model.columns_grab_x > 0;
            if ($) {
              return round2(divideFloat(media_container.width, 2));
            } else {
              return round2(divideFloat(media_container.width, 2)) * -1;
            }
          })()
        }),
        none()
...
function request_modify_media_columns(model, event2) {
  return guard(
    !model.grabbing,
    new Error(toList([])),
    () => {
...
function view(model) {
  return div(
    toList([
      on2("mouseup", (_) => {
        return new Ok(new RequestGrab(false));
      }),
      on2(
        "mousemove",
        (event2) => {
          return request_modify_media_columns(model, event2);
        }
      ),
      class$(
        doTwMerge(
    ...
    toList([
        ...
        toList([
          div(
            ...
            toList([
              ...
              button2(
                ...
                toList([attribute("popovertarget", "popper")]),
                toList(["w-8"]),
                new Ghost()
              ),
              div(
                  ...
                  div(
                    ...
                    toList([
                      div(
                        ...
                        toList([
                          h4(
                            toList([popover_header()]),
                            toList([text2("Willem Dinkelspiel")])
                          ),
                          p(
                            toList([popover_description()]),
                            toList([text2("mail@keii.dev")])
                          )
                        ])
                      )
                    ])
          ...
          div(
            ...
            toList([
              button2(
                toList([
                  house(toList([class$("stroke-zinc-600")])),
                  text2("Home")
                ]),
                toList([]),
      ...
      div(
        toList([class$("grid grid-rows-[58px,1fr]")]),
        toList([
          div(
            toList([
              class$(
            ...
            toList([
              div(
                toList([class$("flex gap-[6px] items-center")]),
                toList([
                  button2(
                    toList([
                      panel_left(toList([class$("size-4 stroke-zinc-400")]))
                    ]),
                    toList([on_click(new RequestToggleSidebar())]),
                    toList(["px-0 w-8"]),
                    new Ghost()
                  ),
                  div(
                    toList([class$("text-zinc-400 font-[525] text-sm")]),
                    toList([text2("My Media")])
                  )
                ])
              ),
              div(
                  ...
                  div(
                    ...
                    toList([
                      div(
                        ...
                        toList([
                          search(toList([class$("size-4 stroke-zinc-400")]))
                        ])
                      ),
                      div(
                        toList([
                        ...
                        toList([
                          command(toList([class$("size-3 stroke-zinc-600")])),
                          text2("K")
                        ])
                      )
                    ])
          ...
          div(
            ...
            toList([
              main(
                toList([class$("flex justify-center"), id("main")]),
                toList([
                  div(
                    toList([
                      class$(
                      ...
                      button2(
                        ...
                        toList([
                          on2(
                            "mousedown",
                            (_) => {
                              return new Ok(new RequestGrab(true));
                            }
                          ),
                          style(
                            toList([
...
function register() {
  let page = application(init2, update, view);
...
function view2(model) {
  return div(
    toList([]),
    toList([element("route-dashboard", toList([]), toList([]))])
  );
}
function main2() {
  let $ = register();
