...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-base-950 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-base-50 data-[state=open]:text-base-500">
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      {'flex flex-col space-y-1.5 text-center sm:text-left': !unstyled},
      className
    )}
    {...props}
  />
  ...
  <DialogPrimitive.Title
    ...
    className={
      unstyled
        ? className
        : cn(
            {'text-lg font-semibold leading-none tracking-tight': !unstyled},
            className
          )
    }
    {...props}
