CREATE TYPE entry_category AS ENUM ('series', 'movie', 'book');
...
CREATE TYPE entry_watch_provider_type AS ENUM ('buy', 'rent', 'flatrate');
...
CREATE TYPE rating_style AS ENUM ('stars', 'range');
...
CREATE TYPE user_list_type AS ENUM ('ordered', 'unordered');
